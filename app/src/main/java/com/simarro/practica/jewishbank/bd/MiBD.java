package com.simarro.practica.jewishbank.bd;
...
import com.simarro.practica.jewishbank.dao.ClienteDAO;
import com.simarro.practica.jewishbank.dao.CuentaDAO;
import com.simarro.practica.jewishbank.dao.MovimientoDAO;
...
public class MiBD extends SQLiteOpenHelper {
    ...
    public void insertarUnCliente(Cliente c){
        int id2=c.getId();
        String nif2=c.getNif().toString();
        String nombre2=c.getNombre().toString();
        String apellidos2=c.getApellidos().toString();
        String clave2=c.getClaveSeguridad().toString();
        String email2=c.getEmail().toString();

        db.execSQL("INSERT INTO clientes(id, nif, nombre, apellidos, claveSeguridad, email) VALUES (id2 , nif2, nombre2, apellidos2, clave2, email2);");
